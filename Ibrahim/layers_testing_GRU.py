...
if __name__ == "__main__":
    ...
    gru_model_1 = Sequential([
        InputLayer((7, 2)),
        GRU(64, activation='relu', name='LSTM1'),
    ...
    gru_model_2 = Sequential([
        InputLayer((7, 2)),
        GRU(64, activation='relu', return_sequences=True, name='LSTM1'),
        GRU(64, activation='relu', name='LSTM2'),
        Dense(64, activation='relu', name='Dense'),
        Dense(2)
    ], name=name)
    ...
    gru_model_3 = Sequential([
        InputLayer((7, 2)),
        GRU(64, activation='relu', return_sequences=True, name='LSTM1'),
        GRU(64, activation='relu', return_sequences=True, name='LSTM2'),
        GRU(64, activation='relu', name='LSTM3'),
        Dense(64, activation='relu', name='Dense'),
        Dense(2)
    ], name=name)

    gru_models = [gru_model_1, gru_model_2, gru_model_3]
